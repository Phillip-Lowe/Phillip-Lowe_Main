...
def load_credentials():
    ...
    # Vultr API key
    vultr_path = os.path.expanduser("~/.openclaw/workspaces/sol/Sol-Knowledge/Sol-Knowledge/credentials/Green/Vultr/VULTR API")
    creds['vultr'] = extract_key(vultr_path) or os.environ.get("VULTR_API_KEY")
    
    # Tailscale auth key (for client VPS to join tailnet)
    ts_auth_path = os.path.expanduser("~/.openclaw/workspaces/sol/Sol-Knowledge/Sol-Knowledge/credentials/Green/Tailscale/Tailscale Auth Key")
    ...
    ts_api_path = os.path.expanduser("~/.openclaw/workspaces/sol/Sol-Knowledge/Sol-Knowledge/credentials/Green/Tailscale/Tailscal API")
    creds['tailscale_api'] = extract_key(ts_api_path) or os.environ.get("TAILSCALE_API_KEY")
    
    # n8n API key
    n8n_path = os.path.expanduser("~/.openclaw/workspaces/sol/Sol-Knowledge/Sol-Knowledge/credentials/Green/n8n/n8n Openclaw api")
