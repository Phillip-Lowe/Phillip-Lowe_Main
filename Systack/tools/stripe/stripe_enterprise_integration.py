...
if not STRIPE_PK or not STRIPE_SK:
    ...
    _cred_path = os.path.expanduser("~/.openclaw/workspaces/sol/Sol-Knowledge/credentials/Green/stripe/keys.json")
...
def create_enterprise_product():
    ...
    try:
        ...
        config_path = os.path.expanduser("~/.openclaw/workspaces/sol/Sol-Knowledge/credentials/Green/stripe/enterprise-config.json")
